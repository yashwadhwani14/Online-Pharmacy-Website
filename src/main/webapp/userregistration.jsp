               ...
               <form action="registerUser" method="post" id="fileForm" role="form">
                  <fieldset>
                     ...
                     <div class="form-group">
                        ...
                        <input required name="userpassword" type="password" class="form-control inputpass" minlength="4" maxlength="16"  id="password" placeholder="Enter password"/> </p>
                        <label for="password"><span class="req">* </span> Password Confirm: </label>
                        <input required name="userpassword" type="password" class="form-control inputpass" minlength="4" maxlength="16" placeholder="Enter again to validate"  id="pass2" onkeyup="checkPass(); return false;" />
